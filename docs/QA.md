...
- Static code inspection: no real identifiers, form for patient data, analytics, remote asset references, fetch calls, or backend dependency. Progress save is opt-in, guarded against unavailable storage, and resettable.
...
- GitHub Pages deployment has not been performed. Test the published URL before placing a QR code in the deck.
