...
- `node tests/quest.mjs`: score formula, speed bonus, tie-breaker ranking, individual scorecards, team averaging, and answer-key alignment for 24 quest questions.
